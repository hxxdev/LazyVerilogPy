typedef union packed {  // @data defines/binding _
logic [9:0] data;
struct packed {  //- @op2 defines/binding Op2
bit [2:0] op2;
...
typedef struct {  //- @a1 defines/binding A1
//- @var5 ref Var5
//- @var6 ref Var6
bit [var5:var6] a1;
...
typedef union {  //- @b1 defines/binding B1
logic [7:0] b1;
//- @s_1 ref S1
