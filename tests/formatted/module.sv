...
module Different_Port_Type(  ///- @input1 defines/binding InDef
  ...
  wire wire1,  //- @bit1 defines/binding BDef
...
module Non_ANSI(  //- @in1 ref In1Def
  in1,  //- @in2 ref In2Def
  in2,  // - @out1 ref Out1Def
  out1);
...
module my_module(  //- @x defines/binding XDef
...
module my_module2(  //- @x defines/binding XDef1
  ...
  //- @#0int2 ref RDef
  //- @#1int2 ref RDef
  input[int1:int2] x[int1:int2],  //- @y defines/binding YDef2
