...
extern interface I(input a, output b);
    ...
    initial begin
        ...
        assertion0: assert #0(1 == 1)
        else $display("Hello!");
        assertion1: assume final (2 != 1)
        else $display("Hello!");
        cover (2 != 1);
        ...
        if (1) begin
            ...
            property
                p2;
                @(posedge clk) a ## 1(b || c)[->1] |-> if (b) p1(d, e)
                else f;
            endproperty
            ...
            property
                ...
                @(posedge clk) strong ((a, r = 1) intersect first_match (b, r = 2)) and not sync_accept_on(c) case
                    ...
                    default: 1;
                endcase
                or (a throughout b or c) implies(a iff always[1:2] b until a s_until b s_until_with a until_with b);
                                            ...
                                            extern forkjoin task t3();
                                                ...
                                                modport m(export foo, function void bar(int, logic), task baz, export func);
                                                        modport n(import function void func(int), import task t2);
                                                            ...
                                                            function void a.bar(int i, logic l);
                                                            endfunction
                                                            task a.baz;
                                                            endtask
                                                            function void a.func(int i);
                                                            endfunction
                                                            ...
                                                            checker
                                                                ...
                                                                a_window: assert property
                                                                    ...
                                                                    generate
                                                                        if (clevel != cover_none) begin
                                                                            : cover_b cover_window_open: cover property
                                                                                (start_event && !window) $display("window_open covered");
                                                                                cover_window: cover property
                                                                                    (start_event && !window ## 1(!end_event && window)[*] ## 1 end_event && window) $display("window covered");
                                                                                end
                                                                                : cover_b
                                                                            endgenerate
                                                                        endchecker
                                                                                ...
                                                                                class G #(type T);
                                                                                    ...
                                                                                    class H #(int p);
                                                                                        ...
                                                                                        class C2 extends B;
                                                                                            ...
                                                                                            rand bit [63:0] value;
                                                                                            rand logic q, r;
                                                                                            constraint value_c{value[63] dist {0: / 70, 1: / 30};
                                                                                            value[0] == 1'b0;
                                                                                            value[15:8] inside {8'h0, 8'hF};
                                                                                            unique {q, r};
                                                                                            solve value before q;
                                                                                            soft value[3:1] > 1;
                                                                                            q -> {value[4] == 0;
                                                                                            } if (q){foreach (value[b]){value[b] == 0;
                                                                                            }} else {disable soft value;
                                                                                            }}
                                                                                        endclass
